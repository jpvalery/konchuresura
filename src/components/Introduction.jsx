	...
	return (
		...
		>
			<Container className="text-lg tracking-tight text-stone-700">
				<p className="pb-8 font-display text-4xl font-bold tracking-tight text-stone-900 md:text-5xl">
				...
				<p className="py-4 font-display text-3xl font-bold tracking-tight text-stone-900 md:text-4xl">
