...
import authorImage from '@/images/avatars/jp-valery-avatar.webp';
			...
			<div className="relative mx-auto max-w-5xl pt-16 sm:px-6">
				<div className="bg-stone-50 pt-px sm:rounded-6xl">
					...
					<div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
						...
						<p className="mt-8 font-sans text-5xl font-extrabold tracking-tight text-stone-900">
							Hey there, I’m <span className="text-emerald-800">Jp</span>, the
							author behind <span className="font-display">Konchu Resura</span>.
						</p>
						<p className="mt-4 text-lg tracking-tight text-stone-700">
							My adventure with 3D printing has come in waves. I first
							experimented back in 2013 when the technology was still finding
							its footing. After dabbling again in 2017, I finally took the
							plunge and got my own Bambu printer in early 2024. Since then, I
							haven't looked back! My printer has been running almost non-stop,
							creating everything from tabletop games and toys to musical
							instruments. Each project teaches me something new, and I love
							sharing what I create with others.
						</p>
						<p className="mt-4 text-lg tracking-tight text-stone-700">
							Konchu Resura is just one of the many projects born from my
							passion for making things come to life through 3D printing. I hope
							you'll print it, play it, and enjoy it as much as I do!
						</p>
						<div className="mt-8 grid grid-flow-col items-center justify-start gap-12">
							<Link
								href="https://twitter.com/jpvalery"
								className="inline-flex items-center text-base font-medium tracking-tight text-stone-900"
							>
								<XIcon className="h-12 fill-current hover:fill-emerald-500 hover:text-emerald-500" />
							</Link>
							<Link
								href="https://makerworld.com/en/@jpvalery"
								className="inline-flex items-center text-base font-medium tracking-tight text-stone-900"
							>
								<MakerWorldIcon className="h-12 fill-current hover:fill-emerald-500 hover:text-emerald-500" />
							</Link>
							<Link
								href="https://thangs.com/designer/jpvalery"
								className="inline-flex items-center text-base font-medium tracking-tight text-stone-900"
							>
								<ThangsIcon className="h-12 fill-current hover:fill-emerald-500 hover:text-emerald-500" />
							</Link>
							<Link
								href="https://www.printables.com/@jpvalery_2045746"
								className="inline-flex items-center text-base font-medium tracking-tight text-stone-900"
							>
								<PrintablesIcon className="h-12 fill-current hover:fill-emerald-500 hover:text-emerald-500" />
							</Link>
						</div>
					</div>
				</div>
